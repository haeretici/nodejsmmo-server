...
class GameSession {
    ...
    constructor(opts) {
        ...
        this.resists = Object.assign({}, DEFAULT_RESISTS);
        this.critChance = 0;
        this.critDamage = 0;
        this.weaponTier = 0;
        ...
        this.lifeLeechChance = 0;
        this.lifeLeechAmount = 0;
        this.manaLeechChance = 0;
        this.manaLeechAmount = 0;
        this._baseCritChance = 0;
        this._baseCritDamage = 0;
        this._gearSkillBonus = Object.create(null);
        this._atkBonus = 0;
        this._speedBonus = 0;
        this._classBaseSpeed = 110;
        this._classResists = null;
        this._classArmorBonus = 0;
        this._lifeLeechChance = 0;
        this._lifeLeechAmount = 0;
        this._manaLeechChance = 0;
        this._manaLeechAmount = 0;
        this.targetId = 0;
